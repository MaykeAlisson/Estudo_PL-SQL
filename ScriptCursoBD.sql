...
-- ADICIONANDO CHAVE PRIMARIA NOMEADA "CONSTRAINTS
...
INSERT INTO BKP.BKP_PRODUTO VALUES(NULL,1000,'TESTE',0.0);

DELIMITER $

CREATE TRIGGER BKP_PRODUTOS
BEFORE INSERT ON PRODUTO
FOR EACH ROW
BEGIN 

	INSERT INTO BKP.BKP_PRODUTO VALUES(NULL, NEW.IDPRODUTO, NEW.NOME,
    NEW.PRECO);
